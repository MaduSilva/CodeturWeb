        ...
        <div className=' footer ' >
            ...
            <Navbar style={{backgroundColor: '#9100D6'}} variant='dark' className='justify-content-around text-white py-3 column align' >
                <Nav className='d-flex flex-column navTxtImg mt-30'>
                    <Nav.Item > Sua plataforma de viagens</Nav.Item>
                </Nav>

                <Nav className='d-flex flex-column mt-30'>
                    <Nav.Item >Fale Conosco : </Nav.Item>
                    <Nav.Item >
                        <svg width="1.2em" height="2em" viewBox="0 0 16 16" className="bi bi-envelope" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        </svg> codetur@contato.com
                        </Nav.Item>
                    <Nav.Item>
                        <svg width="1.1em" height="2em" viewBox="0 0 16 16" className="bi bi-telephone-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='text-center text-light bg-dark py-2'>
                &copy; {new Date().getFullYear()} Copyright: <a className='text-light' href="/"> Codetur.com </a>
            </div>
        </div>
